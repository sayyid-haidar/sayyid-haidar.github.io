...
export function ProjectCard({ project, prominent = false }: ProjectCardProps) {
  return (
    <Link
      ...
      className={cn(
        'group flex min-h-[17rem] flex-col justify-between rounded-2xl border border-line bg-canvas p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#d8d8d5] hover:shadow-[0_20px_50px_rgba(15,23,42,0.07)]',
